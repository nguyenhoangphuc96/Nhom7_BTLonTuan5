...
</title><link href="./web_files/show_img.css" rel="stylesheet" type="text/css">
    <script type="text/javascript" src="./web_files/jquery-1.7.2.min.js.tải xuống"></script>
    <script src="./web_files/Common.js.tải xuống" type="text/javascript"></script>
    <script src="./web_files/PagingContent.js.tải xuống" type="text/javascript"></script>
<link rel="shortcut icon" type="image/png" href="http://icsse2017.hcmute.edu.vn/Resources/Imagephoto/logo.png"><link href="./web_files/lightbox.css" rel="stylesheet" type="text/css">
    <script src="./web_files/lightbox.min.js.tải xuống" type="text/javascript"></script>
    <link href="./web_files/search_Article.css" rel="stylesheet">
...
<link href="./web_files/WebResource.axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"><link href="./web_files/WebResource(1).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"><link href="./web_files/WebResource(2).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"></head>
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPaA8FDzhkNDc3N2M3NDEyOTZjMxgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnUBnINvFbDRYIwV6cAx4iQ9IR7pLg==">
</div>
...
<script src="./web_files/WebResource(3).axd" type="text/javascript"></script>


<script src="./web_files/Telerik.Web.UI.WebResource.axd" type="text/javascript"></script>
<script type="text/javascript">
//<![CDATA[
...
<script src="./web_files/jsdebug" type="text/javascript"></script>
<script src="./web_files/jsdebug(1)" type="text/javascript"></script>
<script src="./web_files/jsdebug(2)" type="text/javascript"></script>
<script src="./web_files/jsdebug(3)" type="text/javascript"></script>
<div>
...
<link href="./web_files/main.css" rel="stylesheet">
<link href="./web_files/mainPortlets.css" rel="stylesheet">
<script language="javascript" type="text/javascript">
    function SearchProcess(event) {
        if (event.keyCode == 13) {
            OnSearch(document.getElementById('txtSearchArticle').value);
		...
		<td colspan="2"><div id="pnTop">
			<div id="pnTopDisplay" style="width:1000px;float:left">
				<div id="ctl06_portlet_83a3e05a-eb99-4512-bd1a-5af90706fcf3" style="width:574px;float:left"><div>
					<div class="P_top">
<div class="P_logo">
<div class="anh_logo"><img alt="" src="./web_files/Banner Hoi nghi quoc te sua.jpg" style="width: 800px; height: 188px;"><br>
</div>
<div class="name_ute">
</div>
</div>
...
<link href="./web_files/nivo-slider.css" rel="stylesheet">
<link href="./web_files/default.css" rel="stylesheet">

<script src="./web_files/jquery.nivo.slider.js.tải xuống"></script>
...
<div class="container" style="height:350px;">
    <div class="slider-wrapper theme-default">
        ...
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="./web_files/HNQT3.jpg" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: none;">
                <img src="./web_files/HNQT2.jpg" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <a href="http://icsse2017.hcmute.edu.vn/" target="_blank" class="nivo-imageLink" style="display: block;">
                <img src="./web_files/HNQT1.jpg" title="" style="height: 350px; width: 1000px; visibility: hidden; display: inline;"></a>
    
        <img class="nivo-main-image" src="./web_files/HNQT1.jpg" style="display: inline; height: auto; overflow: hidden; width: 1000px;"><div class="nivo-caption"></div><div class="nivo-directionNav"><a class="nivo-prevNav">Prev</a><a class="nivo-nextNav">Next</a></div></div><div class="nivo-controlNav"><a class="nivo-control" rel="0">1</a><a class="nivo-control" rel="1">2</a><a class="nivo-control active" rel="2">3</a></div>
    </div>
</div>
<script>
...
<link href="./web_files/Menu.Green.css" rel="stylesheet" type="text/css">
...
<div class="thongbao_phong">
    <div class="topictb_phong_blue">
        ...
        <a class="wobble-horizontal" href="http://icsse2017.hcmute.edu.vn/?TopicId=31ca0f13-71be-4bd9-ad28-d3589a3cf6d2">
            <img src="./web_files/arrow_all_phong.png"></a>
    </div>
...
<div class="truycap_ute">
    <p>Visit month:
        <span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">4,473</span></p>
    <p class="line_footer"></p>
    <p>Visit total:<span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">7,951</span></p>
</div>
